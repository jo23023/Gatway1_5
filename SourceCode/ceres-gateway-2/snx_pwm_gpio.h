...
#define PWM_GPIO_WRITE		  _IOW(SONIX_PWM_MAGIC, 8, unsigned int) /*!< use pwm gpio write the value */
#define PWM_GPIO_READ		    _IOR(SONIX_PWM_MAGIC, 9, unsigned int) /*!< use pwm gpio read the value */
