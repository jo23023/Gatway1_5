...
<div style="z-index: -10; position: absolute; top:64px; width: 100%; ">
    ...
    <div class="pure-g" style="margin-top: 10px;  background-color: white;">
        <div class="pure-u-1 pure-form" style="">
            ...
            <div>
                <input id="camera-name" type="text" placeholder="Camera Name"
                       value="{{confiure_item.name}}" style="width: 100%;">
            </div>
        </div>
    </div>
    ...
    <div class="pure-g" style="background-color: white;">
        <div class="pure-u-1 pure-form" style="">
            ...
            <div>
                <input id="camera-did" type="text" placeholder=""
                       value="{{confiure_item.did}}"style="width: 100%;">
            </div>
        </div>
    </div>
    ...
    <div class="pure-g" style="background-color: white;">
        <div class="pure-u-1 pure-form" style="">
            ...
            <div>
                <input id="camera-password" type="text" placeholder=""
                       value="{{confiure_item.password}}"style="width: 100%;">
            </div>
        </div>
    </div>
    ...
    <div class="pure-g" style="background-color: white;">
        <div class="pure-u-1 pure-form" style="">
            ...
            <div>
                <input id="camera-location" type="text" placeholder="Living Room"
                       value="{{confiure_item.seat}}" style="width: 100%;">
            </div>
        </div>
    </div>
    ...
    <div class="pure-g" style="margin-top: 15px;margin-bottom:90px;">
        <div class="pure-u-1-4 is-center">
            <img class="img-icon-2x" src="images/Search_N.png"
                 onclick="search_ipc_lan();"/>
        </div>
        <div class="pure-u-1-4 is-center">
            <img class="img-icon-2x" src="images/Setting_N.png"
                 onclick="setting_ipc_adv();"/>
        </div>
        <div class="pure-u-1-4 is-center">
            <img class="img-icon-2x" src="images/Cancel_N-N.png"
                 onclick="show_status_page();"/>
        </div>
        <div class="pure-u-1-4 is-center">
            <img class="img-icon-2x" src="images/Save_N.png"
                    onclick="update_ipc();show_status_page();"/>
        </div>
    </div>
</div>
