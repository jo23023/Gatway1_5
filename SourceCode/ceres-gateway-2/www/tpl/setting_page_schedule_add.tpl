...
<div style="position:absolute;z-index: -10; top:64px; width: 98%;">
    <div style="z-index: -10; top:64px; width: 98%; background-color: white; margin: 1%;">
        <table class="pure-table pure-table-horizontal" style="width: 100%; ">
            ...
            <tr>
                <td class="is-center">
                    <div style="float: left"><img class="img-button" src="images/Confirm_N.png" id="sun"
                                                  onclick="change_week('sun')"></div>
                    <div style="float: left">&nbsp;{{i18n "Sunday"}}</div>
                </td>
                <td class="is-center">
                    <div style="float: left"><img class="img-button" src="images/Confirm_N.png" id="thr"
                                                  onclick="change_week('thr')"></div>
                    <div style="float: left">&nbsp;{{i18n "Thursday"}}</div>
                </td>
            </tr>
            <tr>
                <td class="is-center">
                    <div style="float: left"><img class="img-button" src="images/Confirm_N.png" id="mon"
                                                  onclick="change_week('mon')"></div>
                    <div style="float: left">&nbsp;{{i18n "Monday"}}</div>
                </td>
                <td class="is-center">
                    <div style="float: left"><img class="img-button" src="images/Confirm_N.png" id="fri"
                                                  onclick="change_week('fri')"></div>
                    <div style="float: left">&nbsp;{{i18n "Friday"}}</div>
                </td>
            </tr>
            <tr>
                <td class="is-center">
                    <div style="float: left"><img class="img-button" src="images/Confirm_N.png" id="tue"
                                                  onclick="change_week('tue')"></div>
                    <div style="float: left">&nbsp;{{i18n "Tuesday"}}</div>
                </td>
                <td class="is-center">
                    <div style="float: left"><img class="img-button" src="images/Confirm_N.png" id="sat"
                                                  onclick="change_week('sat')"></div>
                    <div style="float: left">&nbsp;{{i18n "Saturday"}}</div>
                </td>
            </tr>
            <tr>
                <td class="is-center">
                    <div style="float: left"><img class="img-button" src="images/Confirm_N.png" id="wed"
                                                  onclick="change_week('wed')"></div>
    ...
    <div style="z-index: -10; top:64px; width: 98%; background-color: white; margin: 1%;">
        <table class="pure-table pure-table-horizontal" style="width: 100%; ">
            ...
            <tr>
                <td>
                    {{i18n "start time"}} : <br/><input style="width: 100%" type="text" readonly id="start-time" value="00:00">
                </td>
            </tr>
            <tr>
                <td>
                    {{i18n "end time"}} : <br/><input style="width: 100%" type="text" readonly id="end-time" value="23:59">
                </td>
            </tr>
